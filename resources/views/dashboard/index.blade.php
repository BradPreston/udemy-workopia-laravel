<x-layout>
    <section class="flex flex-col md:flex-row gap-4">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            @forelse($job_listings as $job)
                <div
                    class="flex justify-between items-center not-last:border-b-2 not-last:border-gray-200 py-2 not-first:mt-5">
                    <div>
                ...
                <div class="mt-4">
                    ...
                    @empty
                        <p class="text-gray-700 bg-gray-200 p-2">No applicants for this job.</p>
                    @endforelse
                </div>
            @empty
